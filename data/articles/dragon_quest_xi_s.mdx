...
and finally I was annoyed with it. It's a totally solid game, but I am unlikely to ever replay it. (It's also very
long!) One of the additions in the defintive edition is a separate 2D version that reenvisions the game as a SNES-era
Dragon Quest. I stayed completely in the 3D version this time (minus Tickington of course), so if I did ever replay it,
I would check that out and see how that changes things.
